...
module.exports = {
    ...
    async run(client, channel) {// en 2m j'ai compris tout le script
        ...
        guild.channels.edit(channel.id, {
            ...channel,
            reason: "Melvy - Anti-ChannelUpdate"
        })

        client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-ChannelUpdate", "Failed to punish the user for updating a channel", "Successfully punished the user for updating a channel")
    }
}