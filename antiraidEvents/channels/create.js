...
module.exports = {
    ...
    async run(client, channel) {
        ...
        if (bypass) return;
        guild.channels.delete(channel.id, "Melvy - Anti-ChannelCreate")

        client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-ChannelCreate", "Failed to punish the user for creating a channel", "Successfully punished the user for creating a channel")
    }
}