...
module.exports = {
    ...
    async run(client, channel) {
        ...
        guild.channels.create({
            ...
            reason: "Melvy - Anti-ChannelDelete"
        })

        client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-ChannelDelete", "Failed to punish the user for deleting a channel", "Successfully punished the user for deleting a channel")
    }
}