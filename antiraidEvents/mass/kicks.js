...
module.exports = {
    ...
    async run(client, kick) {
        ...
        if (data + 1 >= number) {
            client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-MassKick", "Failed to punish the user for kicking multiple users", "Successfully punished the user for kicking multiple users")
