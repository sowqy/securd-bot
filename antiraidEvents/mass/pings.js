...
module.exports = {
  ...
  async run(client, data) {
    ...
    if (userdata >= number) {
      client.util.punish(guild, message.member, config.punish, "Melvy - Anti-MassPings", "Failed to punish the user for mass pings", "Successfully punished the user for mass pings")
