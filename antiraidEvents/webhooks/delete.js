...
module.exports = {
    ...
    async run(client, webhook) {
        ...
        client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-WebhookDelete", "Failed to punish the user for deleting a webhook", "Successfully punished the user for deleting a webhook")
    }
}