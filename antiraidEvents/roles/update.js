...
module.exports = {
    ...
    async run(client, role) {
        ...
        guild.roles.edit(role.role.id, {
            ...role.role,
            reason: "Melvy - Anti-RoleUpdate"
        })

        client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-RoleUpdate", "Failed to punish the user for updating a role", "Successfully punished the user for updating a role")
    }
}