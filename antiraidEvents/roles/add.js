...
module.exports = {
  ...
  async run(client, data) {
    ...
    client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-RolesAdd", `Failed to punish the user for adding a role to ${newData}`, `Successfully punished the user for adding a role to ${newData}`)
  }
} 