...
module.exports = {
    ...
    async run(client, role) {
        ...
        if (bypass) return;
        guild.roles.delete(role.role.id, "Melvy - Anti-RoleCreate")

        client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-RoleCreate", "Failed to punish the user for creating a role", "Successfully punished the user for creating a role")
    }
}