...
module.exports = {
    ...
    async run(client, role) {
        ...
        guild.roles.create({
            ...role.role,
            reason: "Melvy - Anti-RoleDelete"
        }).catch(e => { });

        client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-RoleDelete", "Failed to punish the user for deleting a role", "Successfully punished the user for deleting a role")
    }
}