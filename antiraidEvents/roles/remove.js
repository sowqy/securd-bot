...
module.exports = {
  ...
  async run(client, data) {
    ...
    client.util.punish(guild, executorMember, config.punish, "Melvy - Anti-RolesRemove", `Failed to punish the user for removing a role to ${newData}`, `Successfully punished the user for removing a role to ${newData}`)
  }
} 