...
module.exports = {
    ...
    async run(client, interaction) {
        ...
        function embed() {
            return {
                title: `<:MWelcome:1145892111330328586>・Welcome roles`,
                description: 'Assigns one or more roles to new members.',
                color: process.env.COLOR,
                fields: [
                    { name: `> Configured roles:`, value: config.roles?.map((r) => `<@&${r}>`).join(", ") || "None" },
