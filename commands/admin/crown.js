        ...
        collector.on("collect", async (collected) => {
            if (collected.customId === "add-crown") {
                ...
                const row = new ActionRowBuilder().addComponents(
                    new UserSelectMenuBuilder({ customId: "add-crown-user", placeholder: "Melvy" })
                );
                ...
                buttonCollect = false;
                const menu = new StringSelectMenuBuilder({ customId: "remove-crown-user", placeholder: "Melvy" });
